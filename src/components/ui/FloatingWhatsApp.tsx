...
// 1. Definisikan Props yang akan diterima dari Astro
...
export default function FloatingWhatsApp({
  ...
  // 2. Bersihkan nomor telepon dari karakter non-angka (spasi, +, -, dll)
  const cleanPhone = phoneNumber.replace(/[^0-9]/g, '');
  
  // 3. Rakit URL WhatsApp dengan teks yang di-encode agar aman untuk URL
